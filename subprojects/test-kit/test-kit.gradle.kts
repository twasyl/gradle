...
import org.gradle.gradlebuild.test.integrationtests.registerIntegrationTestTask
...
registerIntegrationTestTask("crossVersionTests", "forking", sourceSets.integTest.get(), TestType.CROSSVERSION) {
